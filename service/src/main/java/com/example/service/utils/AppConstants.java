...
public class AppConstants {
    ...
    public static final String FILE_STORAGE_NOT_FOUND_PATH = "Can not create directory where the uploaded files will be stored";
    ...
    public static final String INVALID_FILE_DIMENSIONS = "Sorry! File is larger than current dimension";
